...
for cont=1:length(Hangle),
    ...
    subplot(3,3,cont)
%     max(Hangle{cont})
    polar_discrete_angles(Hangle{cont}.*select_angles, zeros(1,16),'FontSize',8,'MarkerSize',4,...
                      ...
                      'RadialGridTextFactor',1,'RadialGridFontSize',8);
    title(['(' letters(cont) ')'])
...
%     savefig(['fbm_sintetico_2d'],'dir',imgdir)

end

set(gcf,'color','w')
export_fig('artigo fbm 2d.eps')
